...
const SelectWarehouse = ({
  ...
  const rowClass = id =>
    id === (selected && selected.id) ? classes.rowSelected : classes.row;
...
const mapState = createSelector(
  state => state.order.add.warehouseMap,
  state => state.order.add.warehouseIdList,
  state => state.order.add.warehouseCount,
  state => state.order.add.warehouseTable,
...
export default connect(mapState, mapDispatch)(SelectWarehouse);
