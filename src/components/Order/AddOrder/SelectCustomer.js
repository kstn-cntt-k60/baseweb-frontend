...
import { configCustomerTable, fetchCustomerList } from "../../../actions/order";
...
const mapState = createSelector(
  state => state.order.add.customerMap,
  state => state.order.add.customerIdList,
  state => state.order.add.customerCount,
  state => state.order.add.customerTable,
